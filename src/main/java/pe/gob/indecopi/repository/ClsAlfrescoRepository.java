...
public class ClsAlfrescoRepository implements ClsAlfrescoRepositoryI, Serializable{
	...
	try {	
	    ...
	    String qWhere = "";
	      ...
	      validaciones = validaciones + "  F.indecopicm:expedientes = '"   + objFiltro.getVcIdExpediente() + "-" + objFiltro.getNuAnioExpediente()+"/DSD¬'";
	      validaciones = validaciones + " OR F.indecopicm:expedientes = '" + objFiltro.getVcIdExpediente() + "-" + objFiltro.getNuAnioExpediente()+"/CSD¬'";
	      validaciones = validaciones + " OR F.indecopicm:expedientes = '" + objFiltro.getVcIdExpediente() + "-" + objFiltro.getNuAnioExpediente()+"/OSD¬'";
